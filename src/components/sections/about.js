import { Grid, Section, Wrap } from "../styled"
      ...
      <Wrap>
        <Grid style={{ marginBottom: "3rem" }} cols="1fr 2fr">
          ...
          <div className="flex">
            ...
            <p>
              ...
              Skansen” och ”Lotta på Liseberg”. Tre tisdagskvällar i juli samlas
              varje år omkring 10.000 människor i Nöjesgrytan, i Slottshagen
              [Helsingborg] för att njuta av ett varierat utbud av folkkära och
              rikskända underhållare för alla smaker.
            </p>
          </div>
        </Grid>
        <Grid style={{ marginBottom: "3rem" }} cols="2fr 1fr">
          <div className="flex">
            ...
            <p>
              I över femtio år har det populära allsångs-evenemanget genomförts.
              Mängder av artister har mött publiken i nöjesgrytan, exempelvis
              Eric Saade, Sanna Nielsen, Hasse Andersson, Marianne Mörck,
              Christer Sjögren, Christina Lindberg, Adde Malmberg, Jessica
              Andersson, Jan Johansen m.fl.
            </p>
          </div>
          <div>
            <Img
        ...
        <Grid style={{ marginBottom: "3rem" }} cols="2fr 1fr">
          <div className="flex">
            ...
            <p>
              Kulijuli erbjuder det mesta av det bästa av regionens utbud – där
              lokala och regionala intressenter får möjlighet att visa upp sig
              och sin verksamhet – i kombination med nationella akter i absolut
              toppklass.
            </p>
          </div>
          <div>
        ...
        <Grid cols="1fr 2fr">
          ...
          <div className="flex">
            ...
            <p>
              ...
              Creandia har lång erfarenhet av att arbeta med stora produktioner,
              och med artistbokning.
            </p>
          </div>
        </Grid>
      </Wrap>
